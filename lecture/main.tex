...
\centering
\includegraphics[width=3cm]{figures/15_definitions.png}
...
\textbf{Artificial Intelligence} (AI): cool words to use in grant applications.

\end{frame}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\begin{frame}{Why probabilistic modelling}
    \centering
 \includegraphics[width=10cm]{figures/11_problemedirect.png}
...
\begin{frame}{Why probabilistic modelling}
    \centering
 \includegraphics[width=10cm]{figures/12_problemeinverse.png}
...
\begin{frame}{Why probabilistic modelling}
    \centering
 \includegraphics[width=10cm]{figures/13_errors.png}
...
\begin{frame}{Why probabilistic modelling}
    \centering
 \includegraphics[width=10cm]{figures/14_propagation.png}
...
\begin{frame}{Bayesian data analysis}
    \centering
 \includegraphics[width=10cm]{figures/16_summary.png}
...
\begin{frame}{Advantages}
    \centering
 \includegraphics[width=12cm]{figures/17_applications.png}

\end{frame}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\section{Bayesian data analysis workflow}
...
\begin{frame}{The three steps of Bayesian data analysis}
    ...
    \centering
 \includegraphics[width=8cm]{figures/21_threesteps.png}
...
\textbf{Markov Chain Monte Carlo} algorithms: Metropolis-Hastings, Gibbs, Hamiltonian Monte-Carlo (HMC), No U-Turn Sampling (NUTS), JAX...

generate a sequence $\left\{\theta^{(1)},...,\theta^{(S)}\right\}$ which approximates the posterior $p(\theta | y)$.
...
\begin{frame}{Scoring rules}
    ...
    \centering
 \includegraphics[width=8cm]{figures/validation.png}

\raggedright

Keilman Nico. Évaluer les prévisions probabilistes de population / Evaluating Probabilistic Population Forecasts. In:
Economie et Statistique / Economics and Statistics, n°520-521, 2020. pp. 51-68;
...
Continuous Ranked Probability Score (CRPS)
    ...
    \centering
 \includegraphics[width=7cm]{figures/crps.png}

Image : Itamar Faran, CRPS - A Scoring Function for Bayesian Machine Learning Models
...
\begin{tabular}{lll}
		    ...
		    Stan & \url{https://mc-stan.org/} & R, Python, Julia...\\
...
\begin{itemize}
    \item This tutorial: \url{https://github.com/srouchier/simurex2026}
    \item \textit{Building energy statistical modelling} book: \url{https://BuildingEnergyGeeks.com/}
